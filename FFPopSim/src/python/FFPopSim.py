...
class haploid_highd(object):
    ...
    **Note**: fitness is not a phenotypic trait directly, but rather a function of *all*
    ...
    """
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    def __init__(self, L=0, rng_seed=0, number_of_traits=1, all_polymorphic=False, most_polymorphic=False): 
        """
        ...
        """
        _FFPopSim.haploid_highd_swiginit(self,_FFPopSim.new_haploid_highd(L, rng_seed, number_of_traits, all_polymorphic, most_polymorphic))
    ...
    most_polymorphic = _swig_property(_FFPopSim.haploid_highd_most_polymorphic_get)
    @property
    ...
    def _set_mutant_loci(self, *args, **kwargs):
        """_set_mutant_loci(haploid_highd self, int * IN_ARRAY1)"""
        return _FFPopSim.haploid_highd__set_mutant_loci(self, *args, **kwargs)
...
haploid_highd._set_mutant_loci = new_instancemethod(_FFPopSim.haploid_highd__set_mutant_loci,None,haploid_highd)
