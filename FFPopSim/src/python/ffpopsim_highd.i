...
%ignore is_most_polymorphic;
%feature("autodoc", "Most loci polymorphic? (read-only)") most_polymorphic;
const bool most_polymorphic;
...
/* most_polymorphic mutation rates */
%ignore set_mutant_loci;
void _set_mutant_loci(int* IN_ARRAY1, int DIM1) {
        /* call the C++ method */
