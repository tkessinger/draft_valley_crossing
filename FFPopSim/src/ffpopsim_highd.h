...
public:
	...
	haploid_highd(int L=0, int rng_seed=0, int number_of_traits=1, bool all_polymorphic=false, bool most_polymorphic=false);
	...
	bool circular;				//topology of the chromosome
        ...
        bool is_most_polymorphic(){return most_polymorphic;}
	...
	void set_mutant_loci(int *mut_loci){for(int l=0; l<number_of_mutant_loci; l++) mutant_loci[l] = mut_loci[l];}
