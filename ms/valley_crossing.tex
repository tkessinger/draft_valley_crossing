...
\caption{Ratio of $\alpha$ values at high and low $\sigma$, for varied values of $\mu$. Genetic draft is helpful for crossing deep valleys in the sequential fixation and tunneling regimes, though at large population sizes it can slow down the crossing rate for deep valleys: at higher values of $\mu$ this limitation disappears.}
...
This problem disappears as $\mu$ increases (center and right plots) and the population is far beyond the semi-deterministic tunneling barrier.
