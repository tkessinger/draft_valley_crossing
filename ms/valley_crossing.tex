...
When population sizes are very large or the fitness variation in the population is substantial, however, the behavior of genetic variation is governed more by genetic \emph{draft} than by drift \citep{gillespie_2000, gillespie_2001, masel_2011, neher_shraiman_2011}.
...
Draft is fundamentally different from drift: for example, drafting populations exhibit genealogies that are better described by an alternative coalescent process such as the Bolthausen-Sznitman coalescent or another Beta coalescent \citep{neher_hallatschek_2013, brunet_2007, schweinsberg_2017}, and allele frequencies experience large jumps that cannot be encapsulated by a diffusion approximation \citep{neher_shraiman_2011}.
In addition, the frequency spectrum of neutral alleles is non-monotonic, with a marked uptick near frequency 1--or, equivalently, a depression in intermediate frequency alleles, which are swept out quickly \citep{kosheleva_2013, neher_shraiman_2011}.
...
It is increasingly realized that draft may play a critical role in shaping genetic diversity, especially in many microbes of interest, where population sizes can be large but ``effective population sizes" are many orders of magnitude smaller \citep{masel_2011}.
